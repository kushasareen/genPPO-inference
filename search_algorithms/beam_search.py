...
class BeamSearchTree(Tree):
    ...
    def __init__(self, root: TreeNode, beam_width: int):
    ...
    def beam_search(self, generate_children: Callable[[Any], List[TreeNode]], max_depth: int) -> List[TreeNode]:
        """
        ...
        if len(terminal_nodes) == 0:
            return heapq.nlargest(self.beam_width, current_beam, key=lambda n: n.score)
